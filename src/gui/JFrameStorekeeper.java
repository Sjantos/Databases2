...
public class JFrameStorekeeper extends javax.swing.JFrame {
    JFrame frame;
    DBConnect connect;
     ...
     * @param employeeID
     */
    public JFrameStorekeeper(DBConnect con, int employeeID) {
        initComponents();
        frame = this;
        connect = con;
    ...
    private void initComponents() {
        ...
        panelOptions.setLayout(new java.awt.GridLayout(4, 0));
