 ...
 * @author s.jantos
 */
public class JFrameMakeClientOrder extends javax.swing.JFrame {
    DBConnect connect;
    Container mainPane;
    int width;
    int loggedEmployee;
//    'YYYY-MM-DD'
     ...
     */
    public JFrameMakeClientOrder(DBConnect con, int empID) {
        initComponents();
        connect = con;
    ...
    private void initComponents() {
        ...
        textBoxClientID = new javax.swing.JTextField();
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(textBoxClientID, javax.swing.GroupLayout.PREFERRED_SIZE, 55, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(textBoxClientID, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(47, 47, 47)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
    ...
    private void buttonMakeClientOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonMakeClientOrderActionPerformed
        ...
        try {
            Connection con = connect.getConnection();
            CallableStatement myStmt = con.prepareCall("{call MakeClientOrder(?,?,?,?)}");
        myStmt.setString(1,date.toString());
        myStmt.setInt(2,1);
        myStmt.setInt(3,clientID);
        myStmt.setInt(4,loggedEmployee);
        myStmt.execute();
        } catch (Exception e) {
        ...
        for (int i = 0; i < productIDs.size(); i++) {
            try {
            Connection con = connect.getConnection();
            CallableStatement myStmt = con.prepareCall("{call AddOrderedClientProduct(?,?,?)}");
            myStmt.setInt(1,clientOrderID);
...
public void end()
    ...
    private javax.swing.JTextField textBoxClientID;
